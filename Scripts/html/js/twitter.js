...
QB.Phone.Notifications.LoadTweets = function(Tweets) {
    ...
    if (Tweets !== null && Tweets !== undefined && Tweets !== "" && Tweets.length > 0) {
        ...
        $.each(Tweets, function(i, Tweet){
            ...
            if (Tweet.url == "") {
                let TweetElement = '<div class="twitter-tweet" data-twtcid="'+Tweet.citizenid+'" data-twtid ="'+Tweet.tweetId+'" data-twthandler="@' + TwitterHandle.replace(" ", "_") + '"><div class="tweet-reply"><img src="https://files.fivemerr.com/images/85efde15-627f-4276-abea-2a05e4c21320.png" style="width: 100%;"></div>' +
                    ...
                    '<div class="twt-img" style="top: 8px;"><img src="' + PictureUrl + '" class="tweeter-image"></div>' +
                    '</div>';
                    $(".twitter-home-tab").append(TweetElement);
            } else {
                let TweetElement = '<div class="twitter-tweet" data-twthandler="@'+TwitterHandle.replace(" ", "_")+'"><div class="tweet-reply"><img src="https://files.fivemerr.com/images/85efde15-627f-4276-abea-2a05e4c21320.png" style="width: 100%;"></div>'+
                    '<div class="tweet-tweeter">'+Tweet.firstName+' '+Tweet.lastName+' &nbsp;<span>@'+TwitterHandle.replace(" ", "_")+' &middot; '+TimeAgo+'</span></div>'+
                    '<div class="tweet-message">'+TwtMessage+'</div>'+
                    '<img class="image" src= ' + Tweet.url + ' style = " border-radius:4px;width: 74%; position:relative;z-index: 1;left: 38px;margin: .0rem 0.7rem 0.6rem 1rem;height: auto;padding-bottom: 15px;">' +
                    '<div class="twt-img" style="top: 8px;"><img src="'+PictureUrl+'" class="tweeter-image"></div>' +
                    '</div>';
                $(".twitter-home-tab").append(TweetElement);
            }
    ...
    if (Tweets.length > 0) {
        ...
        $.each(Tweets, function(i, Tweet){
            ...
            '<div class="twitter-tweet">'+
                '<div class="tweet-tweeter">'+Tweet.firstName+' '+Tweet.lastName+' &nbsp;<span>@'+TwitterHandle.replace(" ", "_")+' &middot; '+TimeAgo+'</span></div>'+
                '<div class="tweet-message">'+TwtMessage+'</div>'+
            '<div class="twt-img" style="top: 8px;"><img src="'+PictureUrl+'" class="tweeter-image"></div></div>';
