            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        ...
                        qbMultiCharacters.fadeInDown('.characters-icon', '3.66%', 1);
                        qbMultiCharacters.fadeInDown('.characters-text', '6.26%', 1);
                        qbMultiCharacters.fadeInDown('.characters-text2', '8.66%', 1);
