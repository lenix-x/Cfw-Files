Config = {
    ...
    CancelWalk = false, -- Resets movement type when using the /e c command
    ...
    QuickPrimaryKey = '', -- The primary key name to be used to play the quick animations, for example, the key you specify and the quick animation number to be played will be pressed (LSHIFT + 1, LSHIFT + 2). Check here for more keys https://docs.fivem.net/docs/game-references/controls/.
    -- Pointing
