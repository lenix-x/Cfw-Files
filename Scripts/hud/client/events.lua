...
RegisterNetEvent("hud:Client:HandleCallback", function(key, data)
...
RegisterNetEvent("hud:Client:HiddenHudElement", function(element, code)
    Koci.Client:SendReactMessage("HIDDEN_HUD_ELEMENT", {
        element = element,
        code = code
    })
end)
RegisterNetEvent("hud:Client:ShowHudElement", function(element, code)
    Koci.Client:SendReactMessage("SHOW_HUD_ELEMENT", {
        element = element,
        code = code
    })
end)
RegisterNetEvent("hud:Client:SetManualGear", function(newGear)
...
elseif GetResourceState("saltychat") == "started" then
    ...
    TriggerServerEvent("hud:Server:ErrorHandle", "Setup your custom voice resource at: client/utils.lua")
