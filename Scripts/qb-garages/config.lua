...
Config.Garages = {
    ...
    police = {
        label = 'Police',
        takeVehicle = vector3(425.08, -1010.09, 21.34),
        zone = {
            shape = {
                vector2(436.8, -1009.94),
                vector2(436.78, -1015.41),
                vector2(413.47, -1015.17),
                vector2(413.47, -1009.94)
            },
            minZ = 20.31,
            maxZ = 24.31,
        },
        spawnPoint = {
            vector4(435.11, -1012.9, 21.14, 358.88),
            vector4(431.93, -1013.12, 21.14, 0.71),
            vector4(431.93, -1013.12, 21.14, 0.71),
            vector4(423.46, -1013.04, 21.14, 358.55),
        },
        showBlip = false,
        blipName = 'Police',
        blipNumber = 357,
    ...
    police1 = {
        label = 'Police',
        takeVehicle = vector3(429.41, -993.25, 21.34),
        zone = {
            shape = {
                vector2(436.78, -994.39),
                vector2(436.78, -989.01),
                vector2(421.78, -989.01),
                vector2(421.9, -993.85)
            },
            minZ = 20.31,
            maxZ = 24.31,
        },
