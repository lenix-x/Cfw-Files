    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/weazel.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/wallet.png" style="width: 100%; ">';
                ...
                icon = '<img src="./img/apps/notes.png" style="width: 100%;">';
            }else if (app.app == "whatsapp"){
                icon = '<img src="./img/apps/watsup.png" style="width: 100%;">';
            }
            ...
            if(app.slot > 4){
                $(applicationSlot).append('<div class="application-text">'+app.tooltipText+'</div>');
            }
        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "twitter") {
                    ...
                    $("#mySerial").text(QB.Phone.Data.PlayerData.charinfo.phone);
    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                if (!QB.Phone.Data.IsOpen) {
                    QB.Phone.Animations.BottomSlideUp('.container', 150, -50);
                ...
                $(".notification-time-new").html("now");
